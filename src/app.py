...
def members():
    ...
    if request.method == 'GET':
        ...
        response_body["message"] = "Listado de miembros de Familia"
    ...
    if request.method == 'POST':
        ...
        response_body["message"] = "Quiero agregar un Miembro"
